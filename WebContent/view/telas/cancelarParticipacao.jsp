...
<c:import url="../comum/navbarUsuario.jsp" />
  ...
  <h3>Cancelar participação na atividade: <b>${atvEscolhida.nome}</b>?</h3>
  <div class="row">
    <div class="left">
  ...
  <div class="row">
    ...
    <a class="btn btn-success" href="cancelamentoConfirmado?id=${atvEscolhida.id}">Sim</a>  &nbsp &nbsp
    <a class="btn btn-danger" href="desistir">Não</a>
